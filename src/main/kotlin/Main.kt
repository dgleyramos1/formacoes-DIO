...
fun main() {
    ...
    // Criando usuários
    val ramos = User("Dgley Ramos", "ramos@gmail.com")
    val silva = User("Silva", "silva@gmail.com")

    // Adicionando usuários na formação
    bootcampTQIKotlinBackendDeveloper.register(ramos)
    bootcampTQIKotlinBackendDeveloper.register(silva)
